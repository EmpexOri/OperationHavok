...
func _ready():
	...
	wave_data = [
		...
		{ "Hordling": [6,6,8], "Spewling": [4,6,2], "Biomancer": [1,6,1], "Needling": [3,6,1], "Tumor": [2,6,2], "Gatling": [1,1,1], "Network": [1,0,1], "Bruiser": [1,1,1] },
		{ "Hordling": [7,6,12], "Spewling": [5,6,5], "Biomancer": [2,6,1], "Needling": [4,6,2], "Tumor": [4,6,2], "Network": [1,1,1], "MalignantTumor": [1,1,1] },
